...
contract scaiStakingDEX is Ownable, ReentrancyGuard {
    ...
    {   
        ...
        (uint112 reserve0,, ) = IPancakePair(pancakePair).getReserves();

        // remove previous  wSCAI Portion from total reserve0
        wSCAIPortion =  reserve0 - wSCAIPortion;
        ...
        uint256 totalRewards = wSCAIPortion * APY / 100;
    ...
    function WithdrawStake() external nonReentrant returns (bool)
    {
        ...
        require( contractBalanceInLP >= newUser.amount , "Insufficient contract balance");
